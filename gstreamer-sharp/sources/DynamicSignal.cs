...
namespace GLib
{
	...
	delegate void GClosureMarshal (IntPtr closure, ref GLib.Value retval, uint argc, IntPtr argsPtr, IntPtr invocation_hint, IntPtr data);
	
	public class DynamicSignal
	{
		static readonly int gvalue_struct_size = Marshal.SizeOf (typeof (GLib.Value));
		static readonly int _closureSize = (int)gstsharp_g_closure_get_size ();
		...
		[DllImport ("gobject-2.0.dll")]
		static extern uint g_signal_connect_closure (IntPtr instance, string name, IntPtr closure, bool after);
